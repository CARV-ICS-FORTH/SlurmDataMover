...
private:
	...
	void GetFileNameAndLengthFromServer(char file_name[],
	...
	void ReceiveFilefromServer(int SOCKET);

public:
	PeerClient(std::string ,int);
	void ConnectWithServer(std::string hostname, int portno,std::vector<std::string> files);
